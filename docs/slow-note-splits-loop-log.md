...
| Network access to zenodo.org in the project's environment settings, where GuitarSet lives | C3's GuitarSet half (DECISION-070 ran the corpus half) | 2026-09-24 (door 3 thread) | — |
