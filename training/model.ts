 ...
 * forward pass used by the trainer. A shipped implementation (should a model
 * ever pass its falsifiers — see `docs/DETECTION-FINDINGS.md` for the run
 * that did not) is generated by `export-weights.ts` and pinned to this
 * forward pass by the reference activations saved at export.
 */
